...
type FormInput = Omit<Sale, "id" | "createdAt" | "isActive">;
...
export default function EditSalePage() {
  ...
  // Fetch Sale to be edited
  useEffect(() => {
    const fetchSale = async () => {
      try {
        const { data } = await axios.get(
          `http://localhost:5000/sales/${params?.id}`
        );
        setSale(data);
        setSaleDate(dayjs(data.createdAt));
  ...
  }, [products, customerOptions, params?.id]);
          ...
          <div className="flex flex-col sm:flex-row gap-5 w-full">
            <div className="flex flex-col gap-2 flex-1">
              ...
              <TextField
                ...
                variant="outlined"
                defaultValue={sale.purchaseOrderNumber}
