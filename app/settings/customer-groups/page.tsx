...
import ViewCustomerGroupDetails from "@/components/settings/customer-groups/ViewCustomerGroupDetails";
import AddCustomerGroup from "@/components/settings/customer-groups/AddCudtomerGroup";
